...
| [servers-and-dns.md](servers-and-dns.md) | 🖥️ OVH VPS/dedicated · 🌐 ClouDNS · ✉️ self-hosted mail · 🔗 mesh VPN |
...
| Project size | Deploy |
|---|---|
| Small / one service | A single OVH VPS + Docker Compose. Done. |
...
## Principles
- **Self-hosted, value hardware.** OVH VPS/dedicated, ClouDNS, self-hosted mail — own the stack, control the cost.
